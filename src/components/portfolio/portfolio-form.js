...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: 'https://jeffreyzelaya.devcamp.space/portfolio/portfolio_items',
            apiAction: 'post'
        };
    ...
    deleteImage(imageType) {
        axios
            ...
            .catch(error => {
                console.log("delteImage Error", error)
            })
    }
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length>0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://jeffreyzelaya.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
